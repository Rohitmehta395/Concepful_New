...
import { loadPings, savePings, Ping, SUBTYPE_META, KIND_META } from "@/lib/dashboard/pings";
...
export function MessagesClient() {
  ...
  // Prevent hydration mismatch for generated dates
    ...
    <>
      ...
      {selected && (
        <ConversationModal
          ...
          onNavigate={path => { setSelected(null); router.push(path); }}
        />
      )}
    </>
  );
