...
import { ArrowLeft, Lock, Shield, FlaskConical, CreditCard, ArrowRight } from "lucide-react";
...
function OrderSummary() {
  ...
  if (!mounted) {
    return <div className="animate-pulse h-64 bg-secondary/20 rounded-xl" />;
  }
...
export function CheckoutClient() {
  ...
  }, [emailValid, tier, billing, addOns, aiOpsLevel, email]);

  // Initial mount load
  useEffect(() => {
    if (mounted && !intentCreated) {
      initializePayment();
    }
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-10 max-w-5xl">
      ...
      <TestModeBanner onSkip={() => router.push("/thank-you")} />
