...
import { TIERS, MONTHLY_ADDONS, AI_OPS, calcMonthlyTotal, calcAnnualTotal, TierKey } from "@/lib/pricing";
        ...
        {open && (
          ...
          >
            ...
            <div className="p-4 space-y-4">
              ...
              <Button size="sm" className="w-full font-semibold gap-1" onClick={() => router.push("/pricing")}>
